...
const CRM_PATH_PREFIXES = ["/dashboard", "/leads", "/contacts", "/quotes", "/bookings", "/sequences", "/tasks", "/subscriptions", "/get-in-touch", "/crm-inquiries", "/system-health", "/accounts", "/users", "/company", "/commissions", "/salesboard"];
